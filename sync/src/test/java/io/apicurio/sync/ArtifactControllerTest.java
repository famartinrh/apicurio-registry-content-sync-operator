...
//            .until(() -> registryClient.listArtifactsInGroup(groupId).getCount().intValue() == 1);
//
//        //TODO verify metadata
//
//        artifactK8sClient.create(artifactv2);
//
//        TestUtils.await(() -> registryClient.listArtifactVersions(groupId, "person", 0, 100).getCount() == 2);
//
//        //TODO verify metadata
//
//    }
